...
from hey.jchat.models import Room, Message
...
def test(request):
    ...
    return render_to_response('chat/simple.html', {'js': ['/media/js/mg/chat.js'], 'chat_id':r.pk}, context_instance=RequestContext(request))
